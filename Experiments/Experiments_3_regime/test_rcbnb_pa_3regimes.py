            ...
            for var in dataset_size:
                for switch_thres in list_switch_thres:
                    ...
                    for i in tqdm(range(50)):
                        ...
                        if not os.path.exists(os.path.join('../../results', '3regimes', 'results_rcbnb', str(var))):
                            os.makedirs(os.path.join('../../results', '3regimes', 'results_rcbnb', str(var)))

                        open_file = open(os.path.join('../../results', '3regimes', 'results_rcbnb', str(var), 'switch_thres_' + str(switch_thres) + '_alpha_' + str(pc_alpha)
